def main():
    ...
    desempenho_total = calcular_desempenho(somatorio_nota, somatorio_alunos)
    desempenho_homens = calcular_desempenho(nota_homens, somatorio_homens)
    ...
    print(f'Média geral: {media_nota:.2f}.')
